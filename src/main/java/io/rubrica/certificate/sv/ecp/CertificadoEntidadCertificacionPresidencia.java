...
/**
 * Certificado emitido por la Entidad de Certificación de Presidencia.
 *
 * @author Ricardo Arguello <ricardo.arguello@soportelibre.com>
 * @author Misael Fernández <misael.fernandez.correa@gmail.com>
 */
public abstract class CertificadoEntidadCertificacionPresidencia {

    // OIDs de tipo de certificado: (en caso de implementar)
    public static final String OID_CERTIFICADO_PERSONA_NATURAL = "1.3.6.1.4.1.43745.1.2.1.1";

    // OIDs de Campos del Certificado: (en caso de implementar)
    ...
    public CertificadoEntidadCertificacionPresidencia(X509Certificate certificado) {
